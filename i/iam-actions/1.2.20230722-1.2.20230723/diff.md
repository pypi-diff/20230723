# Comparing `tmp/iam_actions-1.2.20230722.tar.gz` & `tmp/iam_actions-1.2.20230723.tar.gz`
 ...
 * *         "permission to update an authorized application for your AWS Directory', 'resources': "*
