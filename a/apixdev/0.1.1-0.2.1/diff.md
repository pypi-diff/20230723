# Comparing `tmp/apixdev-0.1.1.tar.gz` & `tmp/apixdev-0.2.1.tar.gz`
...
## Comparing `apixdev-0.1.1.tar` & `apixdev-0.2.1.tar`
...
### Comparing `apixdev-0.1.1/LICENSE` & `apixdev-0.2.1/LICENSE`
...
### Comparing `apixdev-0.1.1/apixdev/cli/config.py` & `apixdev-0.2.1/apixdev/cli/config.py`
...
### Comparing `apixdev-0.1.1/apixdev/cli/projects.py` & `apixdev-0.2.1/apixdev/cli/projects.py`
...
### Comparing `apixdev-0.1.1/apixdev/repository.py` & `apixdev-0.2.1/apixdev/core/repository.py`
...
### Comparing `apixdev-0.1.1/apixdev.egg-info/SOURCES.txt` & `apixdev-0.2.1/apixdev.egg-info/SOURCES.txt`
