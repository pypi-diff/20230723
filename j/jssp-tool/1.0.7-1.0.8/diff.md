# Comparing `tmp/jssp_tool-1.0.7-py3-none-any.whl.zip` & `tmp/jssp_tool-1.0.8-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,8 +1,8 @@
-Zip file size: 34650 bytes, number of entries: 48
+Zip file size: 34594 bytes, number of entries: 48
...
+-rw-r--r--  2.0 unx        0 b- defN 23-Jul-23 00:26 jssp_tool/rl/agent/__init__.py
...
+-rw-r--r--  2.0 unx      711 b- defN 23-Jul-23 00:26 jssp_tool/rl/agent/ppo/ppo_discrete.py
 ...
 -rw-r--r--  2.0 unx        0 b- defN 23-Jul-23 00:17 jssp_tool/rl/replay_buffer/a/__init__.py
 -rw-r--r--  2.0 unx     8484 b- defN 23-Jul-23 00:17 jssp_tool/rl/replay_buffer/a/prioritized.py
...
--rw-r--r--  2.0 unx      318 b- defN 23-Jul-23 00:23 jssp_tool-1.0.7.dist-info/METADATA
--rw-r--r--  2.0 unx       92 b- defN 23-Jul-23 00:23 jssp_tool-1.0.7.dist-info/WHEEL
--rw-r--r--  2.0 unx       19 b- defN 23-Jul-23 00:23 jssp_tool-1.0.7.dist-info/top_level.txt
-?rw-rw-r--  2.0 unx     4290 b- defN 23-Jul-23 00:23 jssp_tool-1.0.7.dist-info/RECORD
-48 files, 84961 bytes uncompressed, 27650 bytes compressed:  67.5%
+-rw-r--r--  2.0 unx      318 b- defN 23-Jul-23 00:26 jssp_tool-1.0.8.dist-info/METADATA
+-rw-r--r--  2.0 unx       92 b- defN 23-Jul-23 00:26 jssp_tool-1.0.8.dist-info/WHEEL
+-rw-r--r--  2.0 unx       19 b- defN 23-Jul-23 00:26 jssp_tool-1.0.8.dist-info/top_level.txt
+?rw-rw-r--  2.0 unx     4289 b- defN 23-Jul-23 00:26 jssp_tool-1.0.8.dist-info/RECORD
+48 files, 84931 bytes uncompressed, 27594 bytes compressed:  67.5%
```
...
-Filename: jssp_tool-1.0.7.dist-info/METADATA
+Filename: jssp_tool-1.0.8.dist-info/METADATA
 Comment: 
 
-Filename: jssp_tool-1.0.7.dist-info/WHEEL
+Filename: jssp_tool-1.0.8.dist-info/WHEEL
 Comment: 
 
-Filename: jssp_tool-1.0.7.dist-info/top_level.txt
+Filename: jssp_tool-1.0.8.dist-info/top_level.txt
 Comment: 
 
-Filename: jssp_tool-1.0.7.dist-info/RECORD
+Filename: jssp_tool-1.0.8.dist-info/RECORD
 Comment: 
 
 Zip file comment:
```

## jssp_tool/rl/agent/__init__.py

```diff
@@ -1,3 +0,0 @@
-00000000: 6672 6f6d 202e 7070 6f20 696d 706f 7274  from .ppo import
-00000010: 202a 0a66 726f 6d20 2e64 716e 2069 6d70   *.from .dqn imp
-00000020: 6f72 7420 2a0a                           ort *.
```

## jssp_tool/rl/agent/ppo/ppo_discrete.py

```diff
@@ -1,10 +1,10 @@
 from torch.distributions.categorical import Categorical
 
-from jssp_tool.rl.agent.ppo import PPO
...
## Comparing `jssp_tool-1.0.7.dist-info/RECORD` & `jssp_tool-1.0.8.dist-info/RECORD`
...
+jssp_tool/rl/agent/__init__.py,sha256=47DEQpj8HBSa-_TImW-5JCeuQeRkm5NMpJWZG3hSuFU,0
...
+jssp_tool/rl/agent/ppo/ppo_discrete.py,sha256=5b7LHL22RcyMkNI9tdcqKZfdSbguslSxt51SJQ7DsbA,711
 ...
 jssp_tool/rl/replay_buffer/a/__init__.py,sha256=47DEQpj8HBSa-_TImW-5JCeuQeRkm5NMpJWZG3hSuFU,0
 jssp_tool/rl/replay_buffer/a/prioritized.py,sha256=JkFwwyZckhNPrkLgHnHEhzmUu72V9keOG52nelpbZkU,8484
...
-jssp_tool-1.0.7.dist-info/METADATA,sha256=dmyai1ML65MAkzzdEBtW3-G6V6Hj9L8qfMOkL_58sRQ,318
-jssp_tool-1.0.7.dist-info/WHEEL,sha256=2wepM1nk4DS4eFpYrW1TTqPcoGNfHhhO_i5m4cOimbo,92
-jssp_tool-1.0.7.dist-info/top_level.txt,sha256=UYoYuY2dChwe9ixzTebOVCa9YM_1EXZCvq3gPbMvWic,19
-jssp_tool-1.0.7.dist-info/RECORD,,
+jssp_tool-1.0.8.dist-info/METADATA,sha256=tPtA6Y7N3Q95cZjqCNg59j3H0wWUrhSLb2rYC4CVNfs,318
+jssp_tool-1.0.8.dist-info/WHEEL,sha256=2wepM1nk4DS4eFpYrW1TTqPcoGNfHhhO_i5m4cOimbo,92
+jssp_tool-1.0.8.dist-info/top_level.txt,sha256=UYoYuY2dChwe9ixzTebOVCa9YM_1EXZCvq3gPbMvWic,19
+jssp_tool-1.0.8.dist-info/RECORD,,
```
