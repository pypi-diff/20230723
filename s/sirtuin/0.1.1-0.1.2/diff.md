# Comparing `tmp/sirtuin-0.1.1.tar.gz` & `tmp/sirtuin-0.1.2.tar.gz`
...
### Comparing `sirtuin-0.1.1/src/sirtuin/controllers/aws_beanstalk.py` & `sirtuin-0.1.2/src/sirtuin/controllers/aws_beanstalk.py`
