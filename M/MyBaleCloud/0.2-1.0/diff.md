# Comparing `tmp/MyBaleCloud-0.2.tar.gz` & `tmp/MyBaleCloud-1.0.tar.gz`
...
## Comparing `MyBaleCloud-0.2.tar` & `MyBaleCloud-1.0.tar`
...
### Comparing `MyBaleCloud-0.2/LICENSE.txt` & `MyBaleCloud-1.0/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `MyBaleCloud-0.2/MyBaleCloud/balecloud.py` & `MyBaleCloud-1.0/MyBaleCloud/balecloud.py`
...
### Comparing `MyBaleCloud-0.2/MyBaleCloud.egg-info/PKG-INFO` & `MyBaleCloud-1.0/MyBaleCloud.egg-info/PKG-INFO`
...
### Comparing `MyBaleCloud-0.2/PKG-INFO` & `MyBaleCloud-1.0/PKG-INFO`
...
### Comparing `MyBaleCloud-0.2/setup.py` & `MyBaleCloud-1.0/setup.py`
